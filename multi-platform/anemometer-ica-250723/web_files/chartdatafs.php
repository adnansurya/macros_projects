...
<div class="card-body">
    <canvas id="myChartfs" width= "100px;"></canvas>
        <script type="text/javascript"> 
            var canvas = document.getElementById('myChartfs').getContext('2d');
            var data = {
                labels : [
                    <?php 
            ...
            datasets: [
                ...
                data: [
                <?php 
                    while ($data_r = mysqli_fetch_array($hz)) 
                    { 
                        echo $data_r['frekuensi'].',';
                    }
                ?>
                ],
            },
            {
                ...
                data: [
                <?php 
                    while ($data_s = mysqli_fetch_array($hz2)) 
                    { 
                        echo $data_s['frekuensi2'].',';
                    }
                ?>
                ],
            },
            {
                ...
                data: [
                <?php 
                    while ($data_t = mysqli_fetch_array($hz3)) 
                    { 
                        echo $data_t['frekuensi3'].',';
                    }
                ?>
                ],
            }
                ...
                var myChart = new Chart ('myChartfs',{
                    type : 'line',
                    data : data,
                    options : option,
                });
