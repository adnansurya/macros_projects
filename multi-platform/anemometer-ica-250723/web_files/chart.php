...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $("#chardata").load('chartdata.php');
            $("#chardataas").load('chartdataas.php');
            $("#chardataps").load('chartdataps.php');
            $("#chardataes").load('chartdataes.php');
            $("#chardatapfs").load('chartdatapfs.php');
            $("#chardatafs").load('chartdatafs.php');
                                ...
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <left> <span class="count">Tegangan (RST)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardata">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-4">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Arus (RST)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardataas">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-4">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Daya (RST)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardataps">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-4">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Energi (RST)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardataes">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-4">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">CosPhi (RST)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatapfs">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-4">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Frekuensi (RST)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatafs">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
