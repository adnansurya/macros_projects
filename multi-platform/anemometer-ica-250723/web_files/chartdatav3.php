...
<div class="card-body">
    <canvas id="myChartv3" width= "100px;"></canvas>
        <script type="text/javascript"> 
            var canvas = document.getElementById('myChartv3').getContext('2d');
            var data = {
                labels : [
                    <?php 
            ...
            datasets: [
                ...
                data: [
                <?php 
                    while ($data_t = mysqli_fetch_array($voltage3)) 
                    { 
                        echo $data_t['tegangan3'].',';
                    }
                ?>
                ],
            },
                ...
                var myChart = new Chart ('myChartv3',{
                    type : 'line',
                    data : data,
                    options : option,
                });
