        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="laporanexcel.php"><i class="menu-icon fa fa-print"></i>Cetak data ke <br>EXCEL</br></a>
                        <a href="laporan-cetak.php"target="_blank"><i class="menu-icon fa fa-print"></i>Cetak data ke <br>PDF</br></a>
                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="datarekap" class="table table-striped table-bordered" class="table-responsive-sm">
                                        <thead>
                                            <tr>
                                                <td>No</td>
                                                <td>Tanggal</td>
                                    ...
                                    <tbody>
                                       <?php
                                        error_reporting(0);
                                            ...
                                            $query = $_POST['query'];
                                            if($query){
                                                $data = mysqli_query($konek,"select * from tb_rekap WHERE tanggal LIKE'".$query."' ");
                                            }else{
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="hapus.php?id=<?php echo $d['id']; ?>">Delete</a></td>
                                            </tr>
                                        <?php
                                            }
                                        ?>
