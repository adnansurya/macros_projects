...
<div class="card-body">
    <canvas id="myChartv2" width= "100px;"></canvas>
        <script type="text/javascript"> 
            var canvas = document.getElementById('myChartv2').getContext('2d');
            var data = {
                labels : [
                    <?php 
            ...
            datasets: [
                ...
                data: [
                <?php 
                    while ($data_s = mysqli_fetch_array($voltage2)) 
                    { 
                        echo $data_s['tegangan2'].',';
                    }
                ?>
                ],
            },
                ...
                var myChart = new Chart ('myChartv2',{
                    type : 'line',
                    data : data,
                    options : option,
                });
