...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $("#chardatav2").load('chartdatav2.php');
            $("#chardataa2").load('chartdataa2.php');
            $("#chardatap2").load('chartdatap2.php');
            $("#chardatae2").load('chartdatae2.php');
            $("#chardatapf2").load('chartdatapf2.php');
            $("#chardataf2").load('chartdataf2.php');
        }, 5000); 
    </script>
    <script>
                                ...
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <left> <span class="count">Tegangan (S)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatav2">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Arus (S)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardataa2">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Daya (S)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatap2">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Energi (S)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatae2">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">CosPhi (S)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatapf2">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Frekuensi (S)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardataf2">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
