...
<div class="card-body">
    <canvas id="myChartv" width= "100px;"></canvas>
        <script type="text/javascript"> 
            var canvas = document.getElementById('myChartv').getContext('2d');
            var data = {
                labels : [
                    <?php 
            ...
            datasets: [
                ...
                data: [
                <?php 
                    while ($data_r = mysqli_fetch_array($voltage)) 
                    { 
                        echo $data_r['tegangan'].',';
                    }
                ?>
                ],
            },
                ...
                var myChart = new Chart ('myChartv',{
                    type : 'line',
                    data : data,
                    options : option,
                });
