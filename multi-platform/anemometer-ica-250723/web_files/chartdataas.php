...
<div class="card-body">
    <canvas id="myChartaas" width= "100px;"></canvas>
        <script type="text/javascript"> 
            var canvas = document.getElementById('myChartaas').getContext('2d');
            var data = {
                labels : [
                    <?php 
            ...
            datasets: [
                ...
                data: [
                <?php 
                    while ($data_r = mysqli_fetch_array($current)) 
                    { 
                        echo $data_r['arus'].',';
                    }
                ?>
            ...
            },
            {
                ...
                data: [
                <?php 
                    while ($data_s = mysqli_fetch_array($current2)) 
                    { 
                        echo $data_s['arus2'].',';
                    }
                ?>
            ...
            },
            {
                ...
                data: [
                <?php 
                    while ($data_t = mysqli_fetch_array($current3)) 
                    { 
                        echo $data_t['arus3'].',';
                    }
                ?>
                ...
                var myChart = new Chart ('myChartaas',{
                    type : 'line',
                    data : data,
                    options : option,
                });
