...
<head>
    ...
    <script type="text/javascript">
        var refreshid = setInterval(function(){
            $("#chardatav").load('chartdatav.php');
            $("#chardataa").load('chartdataa.php');
            $("#chardatap").load('chartdatap.php');
            $("#chardatae").load('chartdatae.php');
            $("#chardatapf").load('chartdatapf.php');
            $("#chardataf").load('chartdataf.php');
        }, 5000); 
    </script>
    <script>
                                ...
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <left> <span class="count">Tegangan (R)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatav">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Arus (R)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardataa">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Daya (R)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatap">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Energi (R)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatae">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">CosPhi (R)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardatapf">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
                            ...
                            <div class="content mt-6">
                                <div class="row align-items-left">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <h4 class="card-header">
                                            <left> <span class="count">Frekuensi (R)</span></left>
                                            </h4>
                                            <div class="card-body" id="chardataf">
                                            </div>
                                        </div>
                                    </div>    
                                </div>
