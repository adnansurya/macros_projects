...
<head>
    ...
    <title>Monitoring Kecepatan Angin | Universitas Muslim Indonesia</title>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
           setInterval(function(){
                ...
                $("#cektegangan2").load('cektegangan2.php'),
                $("#cektegangan3").load('cektegangan3.php');
                $("#cekarus").load('cekarus.php');
                $("#cekarus2").load('cekarus2.php');
                $("#cekarus3").load('cekarus3.php');
                $("#cekdaya").load('cekdaya.php');
                $("#cekdaya2").load('cekdaya2.php');
                $("#cekdaya3").load('cekdaya3.php');
                $("#cekenergi").load('cekenergi.php');
                $("#cekenergi2").load('cekenergi2.php');
                $("#cekenergi3").load('cekenergi3.php');
                $("#cekcosphi").load('cekcosphi.php');
                $("#cekcosphi2").load('cekcosphi2.php');
                $("#cekcosphi3").load('cekcosphi3.php');
                $("#cekfrekuensi").load('cekfrekuensi.php');
                $("#cekfrekuensi2").load('cekfrekuensi2.php');
                $("#cekfrekuensi3").load('cekfrekuensi3.php');
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
           <h4><span><img src="images/Logo UMI.png" width="70" height="80"></span><span>  Monitoring Kecepatan Angin </span></h4>
                        ...
                        <form action="simpan.php" method="post">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <p class="card-title" style="text-align:left;"><b style="color:black;">Web Monitoring Kecepatan Angin</b>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-sm-6 col-lg-2">
                                    <div class="card text-white bg-flat-color-1">
                                        <div class="card-body pb-0">
                                            <h4 class="mb-0">
                                            <center> <span class="count">Tegangan</span></center>
                                            </h4>
                                            <br>
                                            <center> <h4> <span id="cektegangan"></span> V </h4> </center>
                                            <br>
                                        </div>
                                    </div>
                                </div> 
                                <div class="col-sm-6 col-lg-2">
                                    <div class="card text-white bg-flat-color-1">
                                        <div class="card-body pb-0">
                                            <h4 class="mb-0">
                                            <center> <span class="count">Arus</span></center>
                                            </h4>
                                            <br>
                                            <center><h4> <span id="cekarus"></span> A</h4></center>
                                            <br>
                                        </div>
                                    </div>    
                                </div>  
                                    ...
                                    <div class="card text-white bg-flat-color-1">
                                        <div class="card-body pb-0">
                                            <h4 class="mb-0">
                                            <center> <span class="count">Daya</span></center>
                                            </h4>
                                            <br>
                                            <center> <h4> <span id="cekdaya"></span>  W</h4> </center>
                                            <br>
                                        </div>
                                    </div>
                                </div> 
                                <div class="col-sm-6 col-lg-2">
                                    <div class="card text-white bg-flat-color-1">
                                        <div class="card-body pb-0">
                                            <h4 class="mb-0">
                                            <center> <span class="count">CosPhi</span></center>
                                            </h4>
                                            <br>
                                            <center><h4> <span id="cekcosphi"></span> pf</h4></center>
                                            <br>
                                        </div>
                                    </div>    
                                </div>
                                <div class="col-sm-6 col-lg-2">
                                    <div class="card text-white bg-flat-color-1">
                                        <div class="card-body pb-0">
                                            <h4 class="mb-0">
                                            <center> <span class="count">Energi</span></center>
                                            </h4>
                                            <br>
                                            <center><h4> <span id="cekenergi"></span> Wh</h4></center>
                                            <br>
                                        </div>
                                    </div>    
                                </div>
                                <div class="col-sm-6 col-lg-2">
                                    <div class="card text-white bg-flat-color-1">
                                        <div class="card-body pb-0">
                                            <h4 class="mb-0">
                                            <center> <span class="count">Frekuensi</span></center>
                                            </h4>
                                            <br>
                                            <center><h4> <span id="cekfrekuensi"></span> Hz</h4></center>
                                            <br>
                                        </div>
                                    </div>    
                                </div>
