...
<div class="card-body">
    <canvas id="myChartes" width= "100px;"></canvas>
        <script type="text/javascript"> 
            var canvas = document.getElementById('myChartes').getContext('2d');
            var data = {
                labels : [
                    <?php 
            ...
            datasets: [
                ...
                data: [
                <?php 
                    while ($data_r = mysqli_fetch_array($energy)) 
                    { 
                        echo $data_r['energi'].',';
                    }
                ?>
            ...
            },
            {
                ...
                data: [
                <?php 
                    while ($data_s = mysqli_fetch_array($energy2)) 
                    { 
                        echo $data_s['energi2'].',';
                    }
                ?>
            ...
            },
            {
                ...
                data: [
                <?php 
                    while ($data_t = mysqli_fetch_array($energy3)) 
                    { 
                        echo $data_t['energi3'].',';
                    }
                ?>
                ...
                var myChart = new Chart ('myChartes',{
                    type : 'line',
                    data : data,
                    options : option,
                });
